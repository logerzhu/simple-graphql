  ...
  _createClass(Context, [{
    ...
    value: function graphQLObjectType(name) {
      ...
      if (!this.graphQLObjectTypes[typeName]) {
        var obj = Object.assign({}, model.config.fields);
        ...
        this.graphQLObjectTypes[typeName] = _index2.default.graphQLFieldConfig(typeName, "", obj, this, interfaces).type;
    ...
    value: function dbModel(name) {
      ...
      if (!this.dbModels[typeName]) {
        ...
        _lodash2.default.forOwn(model.config.fields, function (value, key) {
          ...
          if (fType instanceof _index2.default.ModelRef) {
    ...
    key: 'wrapResolve',
    value: function wrapResolve(type, config) {
      var _this2 = this;
      ...
      this.options.hooks.reverse().forEach(function (hook) {
        if (!hook.filter || hook.filter({ type: type, config: config })) {
          var preHook = hookFun;
    ...
    value: function wrapMutateAndGetPayload(type, config) {
      var _this3 = this;
      ...
      switch (type) {
        case 'mutation':
          return function () {
            var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(args, context, info) {
