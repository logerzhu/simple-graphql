...
export type BaseLinkedFieldType = Class<String> | Class<Number> | Class<Boolean> | Class<Date> | JSON | GraphQLOutputType |
  ModelRef | Type.ScalarFieldType | Connection.ConnectionType | Connection.EdgeType | Array<BaseLinkedFieldType> | {
...
export type LinkFieldTypeConfig = {
  $type:BaseLinkedFieldType,
  description?:string,
  args?:ArgsType,
  resolve: (source:any, args:{[argName: string]: any},
...
export type FieldType = BaseFieldType | FieldTypeConfig
