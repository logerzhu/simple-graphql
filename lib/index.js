...
GS.graphQLInputFieldMap = _transformer2.default.toGraphQLInputFieldMap;
...
GS.build = function (sequelize, models, options) {
  ...
  _lodash2.default.forOwn(context.queries, function (value, key) {
    ...
    if (value.args) {
      finalQueries[key].args = GS.graphQLInputFieldMap(_StringHelper2.default.toInitialUpperCase(key), value.args);
    }
  });
    ...
    mutation: new graphql.GraphQLObjectType({
      ...
      fields: function fields() {
        ...
        _lodash2.default.forOwn(context.mutations, function (value, key) {
          var inputFields = GS.graphQLInputFieldMap(_StringHelper2.default.toInitialUpperCase(key), value.inputFields);
